...
{ 
    public class FamilyLoadHandler
    {
        ...
        public void EnableDocumentOpened()
        {
            m_app.DocumentOpened += OnDocumentOpened;
        }
    ...
    public class LoadFamilyHandler : IExternalEventHandler
    {
        public void Execute(UIApplication app)
        {
            ...
            string pathname2 = @"C:\Users\taco\OneDrive - MEPover\Revit\content\connector position host.rfa";
            Document familyDocument = app.Application.OpenDocumentFile(pathname2);
